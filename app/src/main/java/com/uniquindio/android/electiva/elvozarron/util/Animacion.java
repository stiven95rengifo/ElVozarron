...
/**
 * Clase que permite aplicar animaciones a los compoenentes.
 *
 * @author Stiven Alejandro Rengifo Ospina
 * @author Cristian Camilo Tellez
 * @version 1.0
 * @see /danielme.com/2015/08/12/diseno-android-tarjetas-con-cardview/
 */
public class Animacion {

    /**
     * Metodo que realiza una animacion de expancion
     *
     * @param v
     * @param duration
     */
    ...
    /**
     * Metodo que permite ocultar un componente por medio de una animacion
     *
     * @param v
     * @param duration
     */
    ...
    /**
     * Metodo que permite realizar una transicion o una animacion
     *
     * @param v
     * @param duration
     * @param expand
