...
public class AdaptadorDePortada extends RecyclerView.Adapter<AdaptadorDePortada.AdaptadorPortadaViewHolder> {
     ...
     */
    public class AdaptadorPortadaViewHolder extends RecyclerView.ViewHolder {
